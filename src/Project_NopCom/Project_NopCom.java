package Project_NopCom;

import Utilities.BaseDriver_Project_NopCom;
...
// *********************  XML varsa, burda var, XML'den çalıştır, bu class'tan değil
// *********************  her seferinde 48, 96,144 line'daki email'i değiştir

public class Project_NopCom extends BaseDriver_Project_NopCom {

    @Test(enabled = false,priority = 1, description = "This is register test")
    ...
    @Test(dataProvider = "getData",priority = 2, description = "This is login test")
    public void loginTest(String email, String passwrd) {
        ...
        if (email.equalsIgnoreCase("grup33@gmail.com")) {
    ...
    public Object[][] getData() {
        Object[][] logins = {
                ...
                {"grup33@gmail.com", "Grup123"}, // gecersiz
                {"grup1@gmail.com", "Grup456"}, // gecerli
        };
        return logins;
    }

    @Test (priority = 3, description = "This is tab menu test")
    ...
    @Test (priority = 4, description = "This is gift card test")
    void orderGiftsTest() throws InterruptedException {
        ...
        yourEmail.clear();
        yourEmail.sendKeys("grup1@gmail.com");
    ...
    @Test (priority = 5, description = "This is computer test")
    ...
    @Test (priority = 6, description = "This is Adobe/Photoshop+CS4 test")
    @Parameters("world")
